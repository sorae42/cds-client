<script lang="ts">
	...
	let appbarTransparency = $state(true);
	let scrollY = $state(0);
...
<AppBar classes="fixed {appbarTransparency ? 'bg-transparent' : ''} duration-300">
	{#snippet trail()}
...
<div class="border-surface-100-900 bg-white w-full h-full flex border-[1px]">
